...
//		
//		String pref=sequence.getPrefix();
//		String suf=sequence.getSuffix();
//		int padd=sequence.getPadding();
//		String nextNum=sequence.getNextNumber();
//		
//		 
//		 ArrayList<String> as=new ArrayList<String>(4);
//		 as.add(pref);
//		 as.add(String.format("%0"+nextNum+"d",currentIndex+1));
//		 as.add(suf);
//		
